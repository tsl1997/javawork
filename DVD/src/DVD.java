...
public class DVD {
	...
	public static void main(String[] args) {
		...
		String[] dvdNames = new String[10];//名称，默认“”
		boolean[] dvdStatus = new boolean[10];//借出状态，默认false
		String[] dvdDate = new String[10];//出借日期，默认null
		int[] dvdTimes = new int[10];//出借次数，默认0
		//初始化默认添加一个DVD
		dvdNames[0] = "一剪梅";
		dvdStatus[0] = true;
		dvdDate[0] = "2022-2-22";
